...
export interface Star{
    id: number, size: number, x: number, y: number, opacity: number, animationDuration: number
}
...
export const StarBackground: React.FC = (): ReactElement => {
